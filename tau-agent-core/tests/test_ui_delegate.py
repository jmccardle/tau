...
async def test_veto_emits_start_and_error_end_so_the_tui_can_render_it() -> None:
    ...
    starts = [e for e in events if e.type == "tool_execution_start" and e.tool_name == "guarded"]
    ends = [e for e in events if e.type == "tool_execution_end" and e.tool_name == "guarded"]
