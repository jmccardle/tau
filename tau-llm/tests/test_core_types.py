"""τ-llm's core data types — messages, content blocks, tool-argument validation,
``Model`` serialization, and the frozen ``Usage`` type (``tau_llm.types``,
``tau_llm.tools``).
...
from tau_llm import AssistantMessage, Model, Usage, UserMessage
