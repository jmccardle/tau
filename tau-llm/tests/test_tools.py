"""Tests for tau_llm.tools — Tool definitions and parameter validation.
...
from tau_llm.tools import define_tool, validate_tool_arguments


class TestDefineTool:
    """Smoke tests for define_tool; the rule-by-rule suite is test_define_tool.py."""
