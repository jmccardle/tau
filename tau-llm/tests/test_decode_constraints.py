...
class TestConstraintFieldsHaveExactlyOneDoorIn:
    ...
    def test_decode_constraints_extra_body_cannot_smuggle_a_second_constraint(self, monkeypatch):
    ...
    def test_a_legitimate_decode_knob_in_extra_body_still_works(self, monkeypatch):
        ...
        _patch_client(monkeypatch)
        model = _model(
            grammar_dialect="llguidance", extra_body={"cache_prompt": True, "min_p": 0.05}
        )
