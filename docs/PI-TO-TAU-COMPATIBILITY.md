...
| `@mariozechner/pi-ai` | `tau-llm` | **DIRECT** (provider abstraction) |
...
| Provider registry | `tau_llm.providers.registry` | **DIRECT** |
| Model types | `tau_llm.types.Model` | **DIRECT** (simplified — no compat overrides) |
| Stream options | `tau_llm.types.StreamOptions` | **DIRECT** (core fields only) |
